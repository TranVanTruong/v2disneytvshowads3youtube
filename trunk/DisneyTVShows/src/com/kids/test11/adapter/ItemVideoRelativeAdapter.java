...
public class ItemVideoRelativeAdapter extends BaseAdapter{
	...
	public ItemVideoRelativeAdapter(Context context, ImageLoader imageLoader, DisplayImageOptions options) {
