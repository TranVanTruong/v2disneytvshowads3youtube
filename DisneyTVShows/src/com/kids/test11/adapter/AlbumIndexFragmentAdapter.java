...
public class AlbumIndexFragmentAdapter extends BaseAdapter {
	...
	public AlbumIndexFragmentAdapter(Context context , ArrayList<InfoAlbum> datas, ImageLoader imageLoader, DisplayImageOptions options) {
		this.datas = datas;
